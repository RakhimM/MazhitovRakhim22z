...
async function getImagesFromSupabase() {
    const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$supabase$2f$supabaseClient$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["supabase"].storage.from("products-images").list("products", {
        limit: 100,
        sortBy: {
            column: "created_at",
            order: "desc"
    ...
    if (error) {
        console.error("Ошибка при получении списка изображений:", error.message);
        return [];
    }
    return data?.map((file)=>{
        const { data: urlData } = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$supabase$2f$supabaseClient$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["supabase"].storage.from("products-images").getPublicUrl(`products/${file.name}`);
        return {
            name: file.name,
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__b70bb3._.js.map